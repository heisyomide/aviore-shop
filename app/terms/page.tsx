        ...
        <div className="space-y-20 text-white/60">
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-4 text-[12px] leading-relaxed uppercase tracking-wider">
              <p>
                All pieces listed within the AVIORÉ archive are <span className="text-white">1-of-1 vintage or pre-owned artifacts</span>. Due to the nature of thrifted goods, items may exhibit "Archival Character" (natural wear, distressing, or aging). 
              </p>
              <p>
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-4 text-[12px] leading-relaxed uppercase tracking-wider">
              ...
              <p>
                AVIORÉ reserves the right to cancel any order in the event of technical discrepancies or inventory synchronization errors.
              </p>
            </div>
          </section>

          {/* Section 03: Refund & Exchange Policy */}
          <section className="grid grid-cols-1 md:grid-cols-3 gap-8 p-8 border border-white/10 bg-white/[0.02]">
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-4 text-[12px] leading-relaxed uppercase tracking-wider">
              <p>
                Standard delivery times apply across Nigeria. AVIORÉ is not responsible for delays caused by third-party couriers or incorrect delivery coordinates provided by the user. 
              </p>
            </div>
          </section>
